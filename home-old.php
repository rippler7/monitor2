							...
							<script type="text/javascript">
								...
								setInterval(function() {
								  for (var i = 0; i < slides.length; i++) {
								 	...
								 	var adjDivHeight = (currPicDivHeight * adjDivWidth)/currPicDivWidth;
								 	var divId = $(slides[i]).attr("id");
								 	var topDist = -((currPicDivHeight-adjDivHeight)/2)+"px";
								 	if(currPicDivWidth >= currPicDivHeight){
								 		console.log(topDist);
								 		$("#"+divId+" img").animate({"top":topDist,"height":"100%","opacity":0},500);
								 	}else{
								 		$("#"+divId+" img").animate({"top":topDist,"width":"100%","opacity":0},500);
								 	}
